    ...
    vec![
        ...
        tool(
            ...
            json!({
                ...
                "related_intent_id": { "type": "string", "minLength": 1, "description": "The other intent (int_...) from the related_work entry you are assessing. It may belong to another agent or be one of your own." },
                "verdict": {
                    "type": "string",
